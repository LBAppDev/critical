...
import { Users, Copy, Play, Bot, Loader2, AlertCircle } from 'lucide-react';
...
const LobbyView: React.FC<LobbyViewProps> = ({ 
  ...
  const handleBack = () => {
      setView('MENU');
      window.location.reload(); // Hard reset network
  };
      ...
      <div className="min-h-screen bg-black flex items-center justify-center p-4 relative">
         ...
         <div className="max-w-md w-full space-y-8 relative z-10">
            ...
            <div className="bg-gray-900/80 border border-white/10 p-8 space-y-6 backdrop-blur shadow-2xl">
                ...
                {connError && (
                    <div className="text-red-500 text-xs font-mono bg-red-900/20 p-2 border border-red-500/30 flex items-center gap-2">
  ...
  return (
      <div className="min-h-screen bg-black flex items-center justify-center p-4">
         <div className="max-w-2xl w-full">
            {connError ? (
                <div className="bg-red-900/20 border border-red-500/50 p-8 text-center space-y-4">
                    ...
                    <button onClick={handleBack} className="text-white border border-white/20 px-4 py-2 hover:bg-white/10 font-mono text-sm">RETURN TO MENU</button>
                </div>
            ) : (
                <>
                ...
                {!canStart && (
                    <p className="text-center text-gray-600 text-xs font-mono mt-4">
                         Share the Secure Channel Code <strong>{lobbyCode}</strong> with others to join.
                    </p>
                )}
                </div>
                </>
